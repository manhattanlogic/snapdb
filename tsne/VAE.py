...
class DEA:
    def __init__(self, layer_shapes=[100, 64, 32, 2], pretrain = [],
            ...
            self.ae["learn"] = (self.optimizer.minimize(tf.stack([-self.ae["error"], self.vae_loss])), self.ae["error"], self.vae_loss)
...
if __name__ == "__main__":
    ...
    dea = DEA(layer_shapes = [100, 16, 2], pretrain = [0,1],
